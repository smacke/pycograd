    ...
    abs_for.update(
        {
            ...
            ops.d_fmin: abstract_binary,
            ops.d_logaddexp: abstract_binary,
            ops.d_logaddexp2: abstract_binary,
            ...
            ops.d_diff: ops.diff_abstract_rule,
            ops.d_diag: ops.diag_abstract_rule,
            ops.d_diagonal: ops.diagonal_abstract_rule,
            ops.d_sort: ops._sort_like_abstract,
            ...
            ops.d_linspace: ops.linspace_abstract_rule,
            ops.d_cross: ops.cross_abstract_rule,
            ops.d_kron: ops.kron_abstract_rule,
