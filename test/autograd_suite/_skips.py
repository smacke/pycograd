...
Byte-faithful ports of autograd's originals: the gaps are centralized here and applied in
conftest via ``pytest_collection_modifyitems``. (filename, test name) -> skip reason.
